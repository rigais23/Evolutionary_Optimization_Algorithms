...
if __name__ == '__main__':
    ...
    print(f"Total Execution Time: {optimizer.total_time:.4f} seconds")
    print(f"Total Generations Run:  {optimizer.generations_run}")
    print(f"Total Fitness Calls:  {optimizer.fitness_calls}")
    print("----------------------------")